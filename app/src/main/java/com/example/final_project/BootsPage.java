...
public class BootsPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String fotoVestPath = getIntent().getStringExtra("fotoVestPath");

        next.setOnClickListener(v -> {
            Intent intent = new Intent(BootsPage.this, ResultPage.class);
            intent.putExtra("fotoHelmPath", fotoHelmPath);
            intent.putExtra("fotoVestPath", fotoVestPath);
            intent.putExtra("fotoSepatuPath", fotoSepatu.getAbsolutePath());
