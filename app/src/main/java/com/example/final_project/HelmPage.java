...
public class HelmPage extends AppCompatActivity {

    private ProcessCameraProvider cameraProvider;
    private ImageCapture imageCapture;
    private ImageView imageView;
    private File imageFile;
    private File fotoHelm;
    private static final int MY_PERMISSIONS_REQUEST_WRITE = 223;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.helm_page);
        ...
        next.setOnClickListener(view -> {
            ...
            intent.putExtra("fotoHelmPath", fotoHelm.getAbsolutePath());
            Log.d("HelmPage", "fotoHelmPath: " + fotoHelm.getAbsolutePath());
    ...
    private void capturePhoto() {
        ...
        imageCapture.takePicture(outputFileOptions, ContextCompat.getMainExecutor(this), new ImageCapture.OnImageSavedCallback() {
            ...
            public void onError(@NonNull ImageCaptureException exception) {
                ...
                Toast.makeText(HelmPage.this, "Gagal mengambil gambar", Toast.LENGTH_SHORT).show();
            }
        });
    }
